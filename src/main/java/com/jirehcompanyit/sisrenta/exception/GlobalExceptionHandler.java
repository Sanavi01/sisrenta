package com.jirehcompanyit.sisrenta.exception;

import com.jirehcompanyit.sisrenta.exception.alquiler.AlquilerEstadoException;
...
import com.jirehcompanyit.sisrenta.exception.cliente.NuevoCelularEsIgualAlAnteriorException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AlquilerEstadoException.class)
    public ResponseEntity<String> handleAlquilerEstado(AlquilerEstadoException exception) {
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(exception.getMessage());
    }
